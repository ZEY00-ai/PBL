(function () {
    ...
    document.addEventListener('click', function (e) {
        const btn = e.target.closest('.btn-hapus-geojson');
        if (!btn) return;
        ...
        if (typeof Swal === 'undefined') {
            if (confirm('Yakin hapus data kecamatan ' + nama + '?')) {
        ...
        Swal.fire({
            ...
            html: `Data GeoJSON untuk kecamatan <b>${nama}</b> akan dihapus permanen.`,
            icon: 'warning',
