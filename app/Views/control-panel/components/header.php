                            ...
                            <div class="image">
                                <img id="profile-image"
                                    src="<?= session()->get('user_foto')
                                                ? base_url('uploads/profil/' . session()->get('user_foto'))
...
<script>
    ...
    // Fungsi refresh foto profile (dipanggil setelah upload)
    ...
    // Panggil refresh jika ada flashdata success dari upload
    document.addEventListener('DOMContentLoaded', function() {
        <?php if (session()->getFlashdata('success_foto') || session()->getFlashdata('success')): ?>
            refreshProfilePhoto();
        <?php endif; ?>
    });
</script>
