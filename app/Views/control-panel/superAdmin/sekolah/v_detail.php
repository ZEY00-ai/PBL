                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="m-card">
                                ...
                                <table style="width:100%; border-collapse:collapse;">
                                    ...
                                    <tr style="border-bottom:1px solid var(--m-divider);">
                                        <td style="padding:10px 0; color:var(--m-text-muted);">
                                            <i class="fa-solid fa-hashtag"></i> Kepala Sekolah
                                        </td>
                                        <td style="padding:10px 0;">
                                            <?= $sekolah['kepala_sekolah'] ? esc($sekolah['kepala_sekolah']) : '<span class="text-muted">-</span>' ?>
                                        </td>
                                    </tr>
                                    <tr style="border-bottom:1px solid var(--m-divider);">
                                        <td style="padding:10px 0; color:var(--m-text-muted);">
                                        ...
                                        <td style="padding:10px 0;">
                                            <?= $sekolah['visi'] ? esc($sekolah['visi']) : '<span class="text-muted">-</span>' ?>
                                        </td>
                                    </tr>
                                    <tr style="border-bottom:1px solid var(--m-divider);">
                                        <td style="padding:10px 0; color:var(--m-text-muted);">
                                        ...
                                        <td style="padding:10px 0;">
                                            <?= $sekolah['misi'] ? esc($sekolah['misi']) : '<span class="text-muted">-</span>' ?>
                                        </td>
                                    </tr>
                                    <tr style="border-bottom:1px solid var(--m-divider);">
                                        <td style="padding:10px 0; color:var(--m-text-muted);">
